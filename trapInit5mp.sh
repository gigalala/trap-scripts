...
if [[ "$option" == 1 ]] ;then
    ...
    wget -4 'https://firebasestorage.googleapis.com/v0/b/cameraapp-49969.appspot.com/o/traps%2Ftrap-daily-5mp.py?alt=media&token=3db2d03e-2ff0-4324-820a-11e2fd19defa' -O trap-daily.py
